...
//
//go:embed MEMORY_PROTOCOL.md schema/memory-item.schema.json docs/MEMORY_SCHEMA.md docs/MEMORY_CONTENT_FORMAT.md docs/TAXONOMY.md docs/REPOSITORY_VALIDATION.md docs/USER_COMMANDS.md docs/EXTENDING_GITMEMO.md templates/*.md
